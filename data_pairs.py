...
class SiameseNetworkDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_0 = Image.open(img0_tuple[0])
        img_1 = Image.open(img1_tuple[0])
        img_0 = img_0.convert("L")
        img_1 = img_1.convert("L")
        print(image0_tuple)
        print(image1_tuple[1])
        ...
        return img_0, img_1, torch.from_numpy(np.array([int(img1_tuple[1] != img0_tuple[1])], dtype=np.float32))
